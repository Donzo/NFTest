		...
		async function uploadScore() {
			...
			var testResults = {
				...
				"attributes": [		
    				...
    				}, 
    				{
   					...
   					{
    					"trait_type": "Test Title - File Friendly", 
						"value": testNameFF
   					},
   					{
    					"trait_type": "Address of Test Taker", 
   					...
   					},
				    {
  					...
  					},
  					{
						...
						"value": "https://nftest.net/test-taker?id=" + testID + "&testNameFF=" + testNameFF
   					}
 				]		 
			}
			...
			await fetch('/code/php/results-back.php', {
				...
				body: formData
 				...
 				alert('Your results have been processed. You can now mint your NFT.');
