	<script>	
		...
		function takeTest(){
			...
			while (qsCreated < qsToCreate) {
				...
				//Short Response Question
					...
					qInput = "<div class='short-response-q-input-div-container'><div class='short-response-q-input-div'><fieldset class='short-response-q-input-div' id='" + qInputSetID + "'><div class='short-response-field-container'><div class='srTxtDiv'>Enter Your Response: </div><input class='srInputField' type='text' name=" + qInputSetID + "></div></fieldset></div></div>";
				}
			...
			var submitTestButton = "<div id='submit-test-div' class='content-section submit-test-div'><div id='submit-button' onClick='submitTest()' class='bigButton'>Submit Your Test</div></div>";
		...
		function submitTest(){
			...
			while (qn <= totalQs){
				...
				alert('You got ' + answersRight + ' answers right out of '+ totalQs + ' total questions. That means that you got ' + answersWrong + ' answers wrong. Your total correct is ' + window["cap"] + '%.');
				uploadMyScore();
